...
class DrivingPrivilegeCodeTests: XCTestCase {
    ...
    func testEquality() {
        ...
        XCTAssertEqual(codeA, anotherCodeA, "Codes with the same value should be equal")
        XCTAssertNotEqual(codeA, codeB, "Codes with different values should not be equal")
    }
